...
export default function RfqForm({ countries = [], productName }) {
    ...
    <Panel title="Request for Quotation" bodyClassName="p-4">
      {submitted ? (
        ...
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
          <Input label="Quantity" placeholder="e.g. 500 kg" required />
          <Input label="Target Price" placeholder="e.g. $7.00/kg" required />
