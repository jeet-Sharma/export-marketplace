...
import type { CountryLogisticsInfo } from "@/lib/products";

export interface CountryLogisticsProps {
...
export default function CountryLogistics({ countryLogistics = {} }: CountryLogisticsProps) {
