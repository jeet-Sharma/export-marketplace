...
| Covers | Registration (Platform Admin / Vendor / Buyer) + Vendor Portal: Dashboard, Products, Orders, Inventory, RFQ, Analytics |
| Not covered here | Documents, Profile (will be added later) |
...
Vendor tables: `product`, `inventory`, `stock_movement`, `order` (vendor side), `vendor_earning`, `quotation`.
...
**28 tables.** Documents and Profile will add a few more later.
